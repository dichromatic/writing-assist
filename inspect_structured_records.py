"""
Structured record inspection entrypoint for the non-manuscript experiment.

Usage:
    python inspect_structured_records.py 'examples/story planning/estuary crew summaries.txt'
...
from backend.nlp.experiments.structured_review.cli import build_parser, run_structured_review_experiment


def main() -> int:
    """Parse arguments and run the structured review experiment.
